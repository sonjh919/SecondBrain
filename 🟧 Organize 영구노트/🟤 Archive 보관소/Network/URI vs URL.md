...
URL은 Uniform Resource Locator, 네트워크상에서 통합 자원(리소스)의 “**위치**”를 나타내기 위한 규약이다. 자원 식별자와 위치를 동시에 보여준다는 뜻이며, 다시 말해 웹 사이트의 주소뿐만 아니라 프로토콜([[🟧 Organize 영구노트/🔵 Project 프로젝트/Network/HTTP]])을 함께 나타낸다는 뜻이다.
