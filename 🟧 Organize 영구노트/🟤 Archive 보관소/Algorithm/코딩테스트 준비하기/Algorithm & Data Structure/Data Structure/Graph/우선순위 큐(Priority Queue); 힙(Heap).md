...
**큐([[🟧 Organize 영구노트/🔵 Project 프로젝트/Algorithm/코딩테스트 준비하기/Algorithm & Data Structure/Data Structure/Queue|Queue]]) 는 먼저 들어오는 데이터가 먼저 나가는 **FIFO(First In First Out)** 형식의 자료구조이다.
